...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if use_se:
            ...
            # But RepVGGplus models uses SE after nonlinearity.
            self.se = SEBlock(
    ...
    #   Optional. This may improve the accuracy and
    # facilitates quantization in some cases.
    #   1.  Cancel the original weight decay on
    # rbr_dense.conv.weight and rbr_1x1.conv.weight.
    #   2.  Use like this.
    #       loss = criterion(....)
    ...
    def get_custom_L2(self):
        ...
        t1 = (self.rbr_1x1.bn.weight /
              ((self.rbr_1x1.bn.running_var +
                self.rbr_1x1.bn.eps).sqrt())).\
...
g2_map = {l: 2 for l in optional_groupwise_layers}  # noqa
g4_map = {l: 4 for l in optional_groupwise_layers}  # noqa
