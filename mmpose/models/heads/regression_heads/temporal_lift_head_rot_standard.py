...
from mmpose.models.heads.regression_heads.lift_head_rot_standard import LiftNimbleHeadStandard
...
class TemporalLiftNimbleHeadStandard(LiftNimbleHeadStandard):
    ...
    def __init__(self,
        ...
        self.last_layer = nn.Sequential(
            ...
            nn.ReLU(), nn.Conv2d(self.feat_dim, self.output_num, kernel_size=1))
    ...
    def loss(self,
        ...
        targ_for_loss = [
            ...
            dist_gt, proportion_xyz_gt, gt_nimble_pose, gt_nimble_trans, hand3d_gt
        ]
