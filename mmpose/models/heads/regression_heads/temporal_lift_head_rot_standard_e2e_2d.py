...
class TemporalLiftNimbleHeadStandardE2e2D(LiftNimbleHeadStandard):
    ...
    def preprocess(self, feats, batch_data_samples, mode):
        ...
        # 相机坐标转标准双目
        norm_leftcam_xyz, norm_rightcam_xyz, oricam_left_xyz, oricam_right_xyz = self.standardize_stereo(
    ...
    def predict(self,
        ...
        return hand3d_pred, uv_coord_im_pred_global, mems, all_sigmas
    ...
    def standardize_stereo(self, leftcam_xy, rightcam_xy, left_R, right_R,
        ...
        standard_left_xyz, oricam_left_xyz = self.align_monocular_to_parallel_stereo(
            leftcam_xy, left_R, left_vircam_xf)
        standard_right_xyz, oricam_right_xyz = self.align_monocular_to_parallel_stereo(
        ...
        return norm_left_xyz, norm_right_xyz, oricam_left_xyz, oricam_right_xyz
