...
model = dict(
    ...
    data_preprocessor=dict(type='PoseDataPreprocessor', mean=[0.0], std=[1.0]),
    backbone=dict(
        type='RSNTiny',
        stage_num=1,
...
train_pipeline = [
    dict(
        ...
        bg_lmdb_path_list=[
            ...
            '/home/zx_li/hand_group/data/data_hand/background/20220707_depth_seg_wo_hand_3_lmdb',
            '/home/zx_li/hand_group/data/data_hand/background/20220707_depth_seg_wo_hand_6_lmdb',
            '/home/zx_li/hand_group/data/data_hand/background/20220707_depth_seg_wo_hand_1_lmdb',
            '/home/zx_li/hand_group/data/data_hand/background/20220707_depth_seg_wo_hand_4_lmdb',
            '/home/zx_li/hand_group/data/data_hand/background/20220707_depth_seg_wo_hand_7_lmdb'
        ]),
    dict(
        type='Albumentation',
        transforms=[
