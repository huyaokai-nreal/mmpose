...
model = dict(
    ...
    init_cfg=dict(
        ...
        'work_dirs/td-hand_rsn26_fpn_25d_scale_ipr_dh_right_2d3d_0915data_4x128-100e-128x128/epoch_50.pth'
    ),
...
val_2d_datasets = ['flora_static_finegrain',
                   'flora_dynamic']  #, 'flora_black']
