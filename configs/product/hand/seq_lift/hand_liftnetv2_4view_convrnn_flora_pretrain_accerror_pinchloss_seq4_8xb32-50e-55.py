...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        '/data/AI_DATA/data_hand/model/mmpose/026_td-stage_two_train_55dim_2d_RLE_head_train_flora_majorKPT_flora301302303304_1009/epoch_100.pth'
    ),
)
