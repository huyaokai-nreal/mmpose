...
model = dict(
    ...
    backbone=dict(type='ResNet', depth=18, in_channels=1, out_indices=(3, )),
    head=dict(
        type='DSNTHead',
        in_channels=512,
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        '/home/zx_li/workspace/mmpose/work_dirs/td-hand_res18_hm_8xb64-50e_nreal-256x256/epoch_50.pth'
    ),
)
