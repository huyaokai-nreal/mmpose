...
model = dict(
    ...
    head=dict(
        ...
        loss=dict(
            ...
            losses=[
                ...
                dict(type='BCELoss', use_target_weight=False)
            ]),
        decoder=codec,
        deploy=False,
        output_sigma=True,
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        '/home/zx_li/workspace/mmpose/work_dirs/td-hand_rsntiny_whole_randflip_nonorm_8xb64-100e_nreal-128x128/epoch_100.pth'
    ),
)
...
train_pipeline = [
    ...
    dict(type='GetNegtiveBBox', prob=0.5),
