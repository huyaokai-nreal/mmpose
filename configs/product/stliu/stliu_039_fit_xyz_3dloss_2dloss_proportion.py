    ...
    kpt3d_lift=dict(
        ...
        lift_loss=dict(
            ...
            losses=[
                ...
                dict(type='MSELoss', loss_weight=10, enable_start_epoch=train_cfg['max_epochs'] - 40),  # 2d reprojection left
                dict(type='MSELoss', loss_weight=10, enable_start_epoch=train_cfg['max_epochs'] - 40),  # 2d reprojection right
                dict(
                    type='PinchLoss',
                ...
                dict(type='L1Loss', loss_weight=0.1, enable_start_epoch=train_cfg['max_epochs'] - 40),  # xyz比例损失
                dict(type='MSELoss', loss_weight=0),  # nimble pose直接监督
                dict(type='MSELoss', loss_weight=0),  # nimble trans直接监督
            ]),
        channel_num=55,
        use_kp2d_gt=False,
