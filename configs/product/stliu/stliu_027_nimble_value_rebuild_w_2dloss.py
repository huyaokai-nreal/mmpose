    ...
    kpt3d_lift=dict(
        ...
        lift_loss=dict(
            ...
            losses=[
                ...
                dict(type='MSELoss', loss_weight=1, enable_start_epoch=train_cfg['max_epochs'] - 40),  # 2d reprojection left
                dict(type='MSELoss', loss_weight=1, enable_start_epoch=train_cfg['max_epochs'] - 40),  # 2d reprojection right
                dict(
                    type='PinchLoss',
