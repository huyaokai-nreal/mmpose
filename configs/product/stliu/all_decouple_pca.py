    ...
    kpt3d_lift=dict(
        ...
        lift_loss=dict(
            ...
            losses=[
                ...
                dict(type='L1Loss', loss_weight=0, enable_start_epoch=train_cfg['max_epochs'] - 20),  # xyz比例损失
...
val_evaluator = [
    dict(
        ...
        # bmk_save_root='/data/stliu/mmpose_new/mmpose/work_dirs/result_20240102/bad_case',
        # show_bmk_thr=(30, 10000000),
