...
default_hooks = dict(
    ...
    checkpoint=dict(interval=10, save_best='all mAP', rule='greater'))
...
train_date_list = [
    ...
    '20241114', '20241216', '20250107', '20250113', '20250228'
]
...
# 握拳pinch
# val_date_list = ['20240816']
# val_glasses_list = ['Flora301']
# val_person_list = ['0033']
# 竖向握拳
#val_date_list = ['20240926']
#val_glasses_list = ['Flora301']
#val_person_list = ['0033']
...
#_,val_data_list = get_quest3_anno_paths(data_root)
