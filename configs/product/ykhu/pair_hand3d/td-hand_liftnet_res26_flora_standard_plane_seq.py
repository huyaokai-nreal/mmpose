...
import os
train_cfg = dict(max_epochs=80, val_interval=80)
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        'work_dirs/lift3d/hand_liftnetv2_stdv2_sp_convrnn_flora_pretrain_accerror_pinchloss_seq4_8xb32-50e-55_notest_simulate_2/best_all_mpjpe_epoch_50.pth'
    ),
)
