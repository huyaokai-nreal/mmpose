...
model = dict(
    ...
    init_cfg=dict(
        ...
        f'/data/AI_DATA/jrchen/share-data/epoch_65.pth'
    ),
)
...
train_data_list = [
    ...
    # 8.1
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_0_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_1_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_2_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_5_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_6_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_7_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_0_8_20230801_1_binocular.json',
]
...
val_data_list = [
    ...
    # 8.1
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_0_20230801_1_binocular.json',
    'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_1_20230801_1_binocular.json',
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_2_20230801_1_binocular.json',
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_5_20230801_1_binocular.json',
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_6_20230801_1_binocular.json',
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_7_20230801_1_binocular.json',
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_pinch_1_8_20230801_1_binocular.json',
]
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        point_type='leftcam',   # only use leftcam info
        pinch_random=True
        # indices=1000,
    ),
)
...
val_evaluator = dict(
    ...
    result_dir='.',
    with_tag=False,
    pinch_thre=pinch_thre)  # deal with sequential frame
