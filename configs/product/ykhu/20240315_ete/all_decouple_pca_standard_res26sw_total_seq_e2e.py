...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        ...
        custom_keys={
            ...
            # 'kpt3d_lift': dict(lr_mult=0.0, decay_mult=0.0),
        }),
)
param_scheduler = [
    dict(
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        'work_dirs/liftnimble/0830/all_decouple_pca_standard_res26sw_total_seq_CFA/best_all_mpjpe_epoch_45.pth'
    ),
)
...
train_pipeline = [
    ...
    dict(
        ...
        enable_epoch_num=int(train_cfg['max_epochs']) // 2),
