...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        '/data/AI_DATA/data_hand/model/mmpose/td-hand_rtmnanov2_25d_scale_ipr_right_2d3d_handmix_aug_1031data_simu_4x128-100e-128x128/epoch_100.pth'
    ),
