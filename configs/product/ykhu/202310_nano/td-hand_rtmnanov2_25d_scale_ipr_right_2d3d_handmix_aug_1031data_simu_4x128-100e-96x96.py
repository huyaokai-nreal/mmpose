...
model = dict(
    ...
    init_cfg=dict(
        ...
        '/home/zx_li/workspace/mmpose/work_dirs/td-hand_rtmnanov2_25d_scale_right_2d3d_handmix_aug_1031data_simu_4x128-100e-96x96/epoch_80.pth'
    ),
    ...
    dict(
        ...
        trans_cfg_list=[
            dict(
                ...
                shift_prob=0.5,
                shift_factor=0.2),
            dict(type='TopdownAffine', input_size=crop_size),
...
val_2d_data_list = [
    'data_hand/hand_keypoint/annotations/hand_test_flora_keypoint_261_240119_321_6k__1__binocular__lmdb.json'
]
