...
# model settings
model = dict(
    type='TopdownPoseLiftEstimatorNano',
...
val_data_list = [
    ...
    # 'data_hand/hand_keypoint/annotations3d/Flora_bmk_gesture/XS__20230830_070648__all__normal__right__1111__0005__undistort_tar__Flora303.json',  # 
