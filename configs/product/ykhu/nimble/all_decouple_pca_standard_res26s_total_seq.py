...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        # '/home/ykhu/workspace/mmpose/work_dirs/nimble/res26s/all_decouple_pca_standard_res26s_total/best_all_mpjpe_epoch_95.pth'
        '/home/ykhu/workspace/mmpose/work_dirs/nimble/res26s/all_decouple_pca_standard_res26s_total_seq1/epoch_30.pth'
    ),
)
...
for annotations3d_file_sin in annotations3d_file_list:
    if '20240517' not in annotations3d_file_sin:
...
# hooks
default_hooks = dict(
    checkpoint=dict(interval=2, save_best='all_mpjpe', rule='less'),
