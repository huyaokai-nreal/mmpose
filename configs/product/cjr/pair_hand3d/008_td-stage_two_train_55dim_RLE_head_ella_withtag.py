...
val_data_list = [
    'data_hand/hand_keypoint/annotations3d/ella_with_tag/test_nreal_gesture_0111_seq_spline3d_clean_lmdb_part0000.json',
    ...
    # 'data_hand/hand_keypoint/annotations3d/flora/flora8_1_binocular_0629_1_2.json',
