...
def save_result_json(args, img_path, data_samples, suffix='.png'):
    ...
    with open(os.path.join(args.output_root, file_name), 'w') as f:
        kp_temp = np.concatenate(
            (data_samples.pred_instances['keypoints'][0],
             data_samples.pred_instances['keypoint_scores'][0][:, np.newaxis]),
            axis=1)
...
def main():
    ...
    parser.add_argument(
        '--det_config',
        type=str,
        default='demo/mmdetection_cfg/cascade_rcnn_x101_64x4d_fpn_1class.py',
        help='Config file for detection')
    parser.add_argument(
        '--det_checkpoint',
        type=str,
        default='https://download.openmmlab.com/mmpose/mmdet_pretrained/'
        'cascade_rcnn_x101_64x4d_fpn_20e_onehand10k-dac19597_20201030.pth',
        help='Checkpoint file for detection')
    parser.add_argument(
        '--pose_config',
        type=str,
        default='configs/hand_2d_keypoint/topdown_heatmap/onehand10k/'
        'td-hm_hrnetv2-w18_8xb64-210e_onehand10k-256x256.py',
        help='Config file for pose')
    parser.add_argument(
        '--pose_checkpoint',
        type=str,
        default='https://download.openmmlab.com/mmpose/hand/hrnetv2/'
        'hrnetv2_w18_onehand10k_256x256-30bc9c6b_20210330.pth',
        help='Checkpoint file for pose')
    parser.add_argument(
        '--input',
        type=str,
        default='/data/AI_DATA/data_hand/original_data/hand_keypoint/'
        'simulation_data/test1.4/*.png',
        help='Image path')
    parser.add_argument(
        '--show',
        action='store_true',
    ...
    parser.add_argument(
        ...
        type=str,
        default='/data/AI_DATA/data_hand/original_data/hand_keypoint/'
        'simulation_data/test1.4_pre_anno/',
